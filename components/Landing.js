            ...
            <div className='landing__container'> 
                <motion.main className='landing__main__container'> 
                    <motion.div className='landing__main' variants={appear} initial='hidden' whileInView='visible' viewport={{once: true}} > 
                        ...
                        <h4> 
                           We are disrupting the music industry with an artist first approach, providing state-of-the-art music services, and a home for a growing community of artists.
                        </h4>
            ...
            <section className='landing__info__container'> 
                <motion.div variants={appear} initial='hidden' whileInView='visible' viewport={{once: true}}>
                    <div> 
                        ...
                        <h4> SERVICES </h4> 
                        <p> Whether you need your mix quantized or podcast edited, we will collaborate with you to create something awesome. Our team will provide you the same expertise and personal attention that our signed artists receive.
  </p> 
                    </div> 
                    <div> 
                    <Image src="/label-primary.png" width='60' height='60' unoptimized={true} alt="Star icon superimposed over blue circle"/>
                        <h4> LABEL </h4> 
                        <p> We believe that a record label is an opportunity to inspire personal growth—not a content churning behemoth.
                             We work closely with our artists to foster their skills in recording, producing, and distribution.   </p> 
                    </div>
                    <div> 
                        <Image src="/community-primary.png" width='60' height='60' unoptimized={true} alt="Moon shape superimposed over blue circle" />
                        <h4> COMMUNITY </h4> 
                           <p> Dedicated to making music creation accessible, we foster a close connection with our community. On our Discord server you can connect with like-minded artists, hone your skills, and get an inside look at our label.</p> 
       </div> 
            </motion.div> 
            </section>
            <OutNow /> 
